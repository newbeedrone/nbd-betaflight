...
#if defined(BEEBRAIN_BL_V1_75_CRSF) || defined(BEEBRAIN_BL_V1_SVB_CRSF)
...
#elif defined(BEEBRAIN_BL_V1_SVB) || defined(BEEBRAIN_BL_V1_SVB_CRSF) 
    strcpy(pilotConfigMutable()->name, "SavageBee V1");
...
#elif defined(BEEBRAIN_BL_V1_75) || defined(BEEBRAIN_BL_V1_75_CRSF)
    strcpy(pilotConfigMutable()->name, "BBBL V1 75");
