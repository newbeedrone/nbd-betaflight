...
//     osdElementConfigMutable()->item_pos[OSD_CRAFT_NAME]        = OSD_POS(6, 9) | OSD_PROFILE_1_FLAG;
//     osdElementConfigMutable()->item_pos[OSD_MAIN_BATT_VOLTAGE] = OSD_POS(19, 8) | OSD_PROFILE_1_FLAG;
//     osdElementConfigMutable()->item_pos[OSD_ITEM_TIMER_2]      = OSD_POS(0,  8) | OSD_PROFILE_1_FLAG;
//     osdElementConfigMutable()->item_pos[OSD_FLYMODE]           = OSD_POS(14, 8) | OSD_PROFILE_1_FLAG;
//     osdElementConfigMutable()->item_pos[OSD_VTX_CHANNEL]       = OSD_POS(7,  8) | OSD_PROFILE_1_FLAG;
//     osdElementConfigMutable()->item_pos[OSD_RSSI_VALUE]        = OSD_POS(0, 9) | OSD_PROFILE_1_FLAG;
//     osdElementConfigMutable()->item_pos[OSD_WARNINGS]          = OSD_POS(7, 9);
//     osdElementConfigMutable()->item_pos[OSD_CURRENT_DRAW]      = OSD_POS(18,9) | OSD_PROFILE_1_FLAG;
// #else
...
// #endif 
    ...
    batteryConfigMutable()->vbatfullcellvoltage = 420;
