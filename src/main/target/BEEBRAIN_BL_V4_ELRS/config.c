...
#if defined(BEEBRAIN_BL_V4_ELRS_BASE)
    strcpy(pilotConfigMutable()->name, "BBBL V4 ELRS");

#elif defined(BEEBRAIN_BL_V4_ELRS_65)
    strcpy(pilotConfigMutable()->name, "BBBL V4 ELRS 65");
