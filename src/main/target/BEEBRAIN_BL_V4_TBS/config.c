...
// BASE Defaults
    ...
    strcpy(vtxTableConfigMutable()->powerLabels[3], "MAX");
    ...
    motorConfigMutable()->dev.useBurstDshot = false;
    ...
    strcpy(pilotConfigMutable()->craftName, "BBBL V4");
