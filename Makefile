...
## beebrain_lite   : build beebrain lite targets
beebrain_lite: $(GROUP_BEEBRAIN_LITE_TARGETS)

## beebrain_pro    : build beebrain pro targets
beebrain_pro: $(GROUP_BEEBRAIN_PRO_TARGETS)

## beebrain_bl_v1    : build beebrain bl v1 targets
beebrain_bl_v1: $(GROUP_BEEBRAIN_BL_V1_TARGETS)
