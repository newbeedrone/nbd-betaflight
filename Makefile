...
## targets_bb_lite   : build beebrain lite targets
beebrain_lite: $(GROUP_BB_LITE_TARGETS)

## targets_bb_pro    : build beebrain pro targets
beebrain_pro: $(GROUP_BB_PRO_TARGETS)

## beebrain_bl_v1    : build beebrain brushless v1 targets
beebrain_bl_v1: $(GROUP_BBBL_V1_TARGETS)
...
## beebrain_bl_v4_elrs : build beebrain brushless v4 elrs targets
beebrain_bl_v4_elrs: $(GROUP_BBBL_V4_ELRS_TARGETS)
